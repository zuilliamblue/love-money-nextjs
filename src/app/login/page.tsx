...
export default function LoginPage() {
  ...
  async function loginEmailSenha(e: React.FormEvent) {
    console.log('loginEmailSenha chamado'); 
    e.preventDefault();
    setErro('');
    setCarregando(true);
    try {
  ...
  async function loginGoogle() {
    console.log('loginGoogle chamado');
  setErro('');
  setCarregando(true);
  try {
    ...
    // AQUI: chama a função que grava no Firestore
    await criarUsuarioNoFirestore(user);
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col justify-center items-center p-4">
      <img src="logo.png" alt="LoveMoney" className="w-40 mb-6 drop-shadow-[0_0_15px_gold]" />
